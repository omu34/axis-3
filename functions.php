...
function axis_scripts() {
    ...
    wp_enqueue_style('axis-carousel', "https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/owl.theme.default.min.css", array(), "2.3.4", "all");
    ...
    wp_enqueue_style('axis-flowbite', "https://cdnjs.cloudflare.com/ajax/libs/flowbite/1.8.0/flowbite.min.css", array(), "1.8.0", "all");
    ...
    wp_enqueue_script('axis-flowbite', "https://cdnjs.cloudflare.com/ajax/libs/flowbite/1.8.0/flowbite.min.js", array(), "1.8.0", true);
	wp_enqueue_script('axis-flowbites', "https://unpkg.com/flowbite@1.4.0/dist/flowbite.js", array(), "1.4.0", true);
